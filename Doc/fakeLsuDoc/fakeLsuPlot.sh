cat fakeLsuNormal |awk -F '=' 'NR>1{print $2, $4}' |awk  '{print $1, $3}' >gnuplotDelayv1.log
cat fakeLsuAttack |awk -F '=' 'NR>1{print $2, $4}' |awk  '{print $1, $3}' >gnuplotDelayv2.log
cat fakeLsuProtect |awk -F '=' 'NR>1{print $2, $4}' |awk  '{print $1, $3}' >gnuplotDelayv3.log 

gnuplot -persist <<EOF
set multiplot layout 3,1
set title "发送伪Lsu包攻击状态下时延结果对比图" 
set xlabel'仿真时间(s)'
