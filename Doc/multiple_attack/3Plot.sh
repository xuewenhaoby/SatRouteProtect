cat fakeHello_fakeLsu_Normal |awk -F '=' 'NR>1{print $2, $4}' |awk  '{print $1, $3+30}' >gnuplotDelayv1.log
cat fakeHello_fakeLsu_modifyLsu_Attack |awk -F '=' 'NR>1{print $2, $4}' |awk  '{print $1, $3+30}' >gnuplotDelayv2.log
cat fakeHello_fakeLsu_Protect |awk -F '=' 'NR>1{print $2, $4}' |awk  '{print $1, $3+32}' >gnuplotDelayv3.log
gnuplot -persist <<EOF
